...
| --------------------------------------------------------------------- | -------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| [quenchant](crates/quenchant/README.md)                               | `#[quenchant::spec(...)]`                    | Consumer namespace for the specification facade                                                 |
...
The `quenchant` package carries the specification attribute:
