...
enum Eligibility
{
    ...
    CratesIo,
    /// The fixture package cannot be published.
    Disabled,
}
...
const BOUNDARY: &[(&str, Eligibility)] = &[
    ...
    ("quenchant-dylints", Eligibility::CratesIo),
...
///
/// # Specification
/// - ensures: the eight declared packages are present, seven restricted to
///   crates.io and fixture macros disabled.
...
mod tests
{
    ...
    fn golden() -> serde_json::Value
    {
        serde_json::json!({"packages": [
            ...
            {"name": "quenchant-dylints", "publish": ["crates-io"]},
